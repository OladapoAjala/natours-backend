...
var showAlert = function showAlert(type, msg) {
  hideAlert();
  var markup = "<div class='alert alet--".concat(type, ">").concat(msg, "</div>");
...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1Ijoib2xhZGFwby1hamFsYSIsImEiOiJja3RvazdyNjEwMTdpMzJucWQzNDVydnNwIn0.a68Zz7IFQVD7D3QIyJGDhQ';
